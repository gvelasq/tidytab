# Getting help with tidytab

Thanks for using tidytab! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/gvelasq/tidytab/issues/new).
...
requests](https://github.com/gvelasq/tidytab/issues) to make sure the
