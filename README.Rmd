...
[![Travis build status](https://travis-ci.org/gvelasq/tidytab.svg?branch=master)](https://travis-ci.org/gvelasq/tidytab)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/gvelasq/tidytab?branch=master&svg=true)](https://ci.appveyor.com/project/gvelasq/tidytab)
[![Coverage status](https://codecov.io/gh/gvelasq/tidytab/branch/master/graph/badge.svg)](https://codecov.io/github/gvelasq/tidytab?branch=master)
