...
This outlines how to propose a change to tidytab. For a detailed
discussion on contributing to tidytab, please see the tidyverse team’s
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("gvelasq/tidytab", fork = TRUE)`.
...
Code of Conduct](https://gvelasq.github.io/tidytab/CODE_OF_CONDUCT.md).
