...
This explains how to propose a change to tabr via a pull request using
Git and GitHub. 
...
the [tabr GitHub repo](https://github.com/gvelasq2/tabr), and 
...
results for [tabr on Travis](https://travis-ci.org/gvelasq2/tabr) (checks on Linux and/or 
